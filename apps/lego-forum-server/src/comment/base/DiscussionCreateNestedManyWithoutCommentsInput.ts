...
@InputType()
class DiscussionCreateNestedManyWithoutCommentsInput {
...
export { DiscussionCreateNestedManyWithoutCommentsInput as DiscussionCreateNestedManyWithoutCommentsInput };
